...
const CORE_ASSETS = [
  ...
  './css/views/day-preview-sheet.css',
  './css/views/stats.css',
  './css/theme-quick-picker.css',
  './css/tab-bar-position.css',
  './css/swipe-hint.css',
  './js/config.js',
  './js/date-utils.js',
  './js/dom-utils.js',
  ...
  './js/tree-icons.js',
  './js/confirm-modal.js',
  './js/habit-range-modal.js',
  './js/theme-editor-modal.js',
  './js/event-section.js',
  './js/habit-note-panel.js',
  './js/long-press.js',
  './js/swipe-nav.js',
  './js/swipe-nav-vertical.js',
  './js/swipe-hint.js',
  './js/theme-quick-picker.js',
  './js/tab-bar-position.js',
